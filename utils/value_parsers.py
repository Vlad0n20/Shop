...
phone_regex = RegexValidator(
    regex=r"^\+\d{9,15}$",
    message=_(
        "The phone number must be entered in the format: "
        ...
        if self.content_types:
            ...
            if (
                not (
                    ...
                    and (data.name.endswith(".docx") or data.name.endswith(".xlsx"))
                )
...
avatar_validator = FileValidator(
    max_size=10485760, content_types=("image/jpeg", "image/png")
)
